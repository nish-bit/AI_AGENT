...
system_prompt = """You are Dora — a witty, clever, and helpful assistant.
    Here’s how you operate:
        ...
        - Don’t ask for permission to look through the webcam, or say that you need to call the tool to take a peek — call it straight away. ALWAYS call the required tools and take the picture.
...
llm = ChatGoogleGenerativeAI(
    model="models/gemini-1.5-flash",  # ✅ Updated model ID
    temperature=0.7,
)
